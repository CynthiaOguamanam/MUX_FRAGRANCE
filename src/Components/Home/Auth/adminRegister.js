...
const AdminRegister = () => {
  ...
  const onSubmit = handleSubmit(async (val) =>{
    ...
    const url = `${localURL}/api/user/admin`;
  ...
  return (
    <Container>
        ...
        <Wrapper>
            <LogoDiv>
              <Logo  src='/cart.svg'/>
              <h2>Admin Register With Mux_Fragrance</h2>
            </LogoDiv>
            ...
            <Error>{errors?.email?.message}</Error>
              ...
              <Input placeholder='e.g: 02088997256' type='number'  {...register("contact")}/>
            <Error>{errors?.contact?.message}</Error>
              </InputHold>
              <InputHold>
              <legend>Address: </legend>
              <Input placeholder='e.g: 72 juny Lane, Ajegunle Lagos' type='text'  {...register("address")}/>
